...
def relvals_creationABANDONED(new):
    """
...
def pu_creationABANDONED(pu):
    ...
    if len(pu) == 0:       #If the new releases list does not contain PU tickets then we are done
        ...
        #Putting the ticket on the server
            ...
            #Trying to create relvals
                ticket_relvals = creating_relvals(ticket_prepid)
                #This command creates relvals and also returns the ticket relvals
